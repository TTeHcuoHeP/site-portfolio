...
export const projects: Project[] = [
  {
    ...
    tools: ["Photoshop", "Figma", "Illustrator", "AI", "DaVinci"],
  ...
  },
  {
    ...
    tools: ["Photoshop", "Illustrator", "InDesign", "DaVinci", "AI"],
  ...
  },
  {
    title: "VacationFlow",
    slug: "vacationflow",
    subtitle: "Interactive personal platform combining portfolio, services, and experience.",
    ...
    roleDescription: "Owned the full process: concept, UX/UI, content, art direction, front-end implementation, motion design, and AI-assisted development workflow.",
    ...
    overview: [
      "VacationFlow is structured as a personal digital system rather than a static portfolio, combining story, services, motion, and project navigation.",
      "The platform explores how AI-assisted workflows can support fast iteration while keeping a strong editorial design direction.",
    ],
  ...
  },
  {
    ...
    tools: ["Figma", "Photoshop", "Illustrator", "AI", "3ds Max"],
